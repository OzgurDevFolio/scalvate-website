export const features = [
    {
        ...
        caption: 'THE SCALVATE ADVANTAGE',
        title: 'Engineered for ROI',
        text: 'No more guesswork. Scalvate uses cutting-edge analytics and predictive insights. We craft strategies to maximize your measurable ROI.',
        button: {
    ...
    },
    {
        ...
        title: 'Your Ambition Our Obsession',
...
export const faq = [
    {
        id: '0',
        question: 'How soon will we start seeing results?',
        answer: 'While results vary, most clients see traction in the first 2–4 weeks. Paid ads typically bring leads fastest, while SEO and email marketing compound over time. We aim for measurable ROI within 90 days.',
    },
    {
        id: '1',
        question: 'Do you guarantee leads or results?',
        answer: 'Absolutely. If you don’t generate at least $100,000 in new revenue, we’ll continue working with you completely free until you do. We’re not here to invoice—you win, or we keep pushing until you do.',
    },
    {
        id: '2',
        question: 'What makes you different from other agencies?',
        answer: 'We don’t do cookie-cutter marketing. Everything we build is tailor-made for SaaS growth. From your outbound strategy to ad funnels and emails, we execute with one goal in mind: qualified revenue growth—not just impressions or clicks.',
    },
    {
        id: '3',
        question: 'Can we work with you if we already have a marketing team?',
        answer: 'Definitely. Many of our clients have internal teams—we plug in as a specialized growth engine, focused on what your team doesn’t have time or expertise to handle (like cold outreach, CRO, or full-funnel ad campaigns).',
    },
    {
        id: '4',
        question: 'How do you qualify leads before booking appointments?',
        answer: 'We don’t just fill your calendar—we filter it. Every lead goes through audience targeting, custom messaging, and qualification logic. You only take meetings with people who match your ICP and have a high buying intent.',
    },
    {
        id: '5',
        question: 'Do you offer one-off services?',
        answer: 'We primarily work on monthly retainers because that’s where our full system delivers best. That said, we occasionally take on one-off projects like audits, landing page rewrites, or ad sprint campaigns if it’s a strong fit.',
    },
    {
        id: '6',
        question: 'What ad platforms do you work with?',
        answer: 'Google Ads and Meta (Facebook/Instagram) are our bread and butter for SaaS. On the Dominate plan, we also run LinkedIn ads for deeper B2B targeting, including retargeting across platforms.',
    },
    {
        id: '7',
        question: 'What about reporting and transparency?',
        answer: 'You’ll get detailed performance reports every week or bi-weekly (depending on your plan), plus dashboards showing SEO growth, ad performance, email KPIs, booked appointments, and qualified revenue. No fluff—just real numbers.',
    },
    {
        id: '8',
        question: 'What if we’re not ready for the full Dominate plan?',
        answer: 'That’s completely fine. Most SaaS clients start with the Launch or Scale plans and move up as their revenue grows. You’re never locked in — we scale with you.',
    },
    {
        id: '9',
        question: 'What does the onboarding process look like and how soon can we get started?',
        answer: 'Once you sign, we kick off with a strategy call and onboarding form. Within 7 days, your campaigns are live. We don’t waste time—speed is a competitive advantage in SaaS.',
    },
]
...
export const plans = [
    {
        ...
        features: ['SEO Site Audit & Fixes', 'Welcome Email + Lead Magnet Funnel', 'Foundational Copywriting', 'Cold Outreach Setup', '24/7 support', 'Weekly Slack Support + Monthly Reporting'],
    ...
    },
    {
        ...
        features: [
            ...
            '2x Weekly SEO-Driven Blog Posts',
            '10-Email Lifecycle Sequence',
...
export const testimonials = [
    {
        id: '0',
        name: 'Alicia Reyes',
        role: 'Head of Growth @ DevKit AI',
        avatarUrl: '/images/testimonials/jessica-saunders.png',
        comment: 'Scalvate helped us go from unpredictable leads to a steady flow of qualified demos within weeks. Their outbound strategy just works.',
    },
    {
        id: '1',
        name: 'Daniel Cho',
        role: 'Co-founder @ NotifyEdge',
        avatarUrl: '/images/testimonials/mark-erixon.png',
        comment: 'We’d burned money on ads before, but Scalvate actually made them profitable. Our CAC dropped by 40% in two months.',
    },
    {
        id: '2',
        name: 'Maria Novak',
        role: 'CMO @ Syncrospace',
        avatarUrl: '/images/testimonials/melanie-hurst.png',
        comment: 'Our website traffic was decent, but conversions were flat. After Scalvate rewrote our landing pages and emails, signups jumped by 29%.',
    },
    {
        id: '3',
        name: 'Aliya Mills',
        ...
        comment: 'Scalvate plugged right into our team and owned the growth channels we didn’t have time for. Booked meetings with ICPs started rolling in.',
    },
    {
        id: '4',
        name: 'Tina Kumari',
        role: 'Head of Operations @ LeadLoop',
        avatarUrl: '/images/testimonials/becky-snider.png',
        comment: 'We were hesitant at first, but their cold outreach system is legit. Within 30 days, we closed two deals from leads they brought in.',
    },
    {
        id: '5',
        name: 'Ryan Becker',
        role: 'Co-founder @ Shiplytic',
        avatarUrl: '/images/testimonials/jim-bradley.png',
        comment: 'I’ve worked with other agencies, but Scalvate actually delivers on what they promise. Paid ads, copy, and email—everything clicked.',
    },
]
...
export const socials = [
    {
        ...
        url: 'https://www.instagram.com/scalvate.io',
    },
    {
        id: '1',
        title: 'Facebook',
        icon: '/images/socials/facebook.svg',
        url: 'https://www.facebook.com/profile.php?id=61550674593691',
    },
    {
        id: '2',
        title: 'LinkedIn',
        icon: '/images/socials/linkedin.svg',
        url: 'https://www.linkedin.com/in/ozgurdemirbacak/',
    },
    {
        id: '3',
        title: 'Calendly',
        icon: '/images/socials/calendar.png',
        url: 'https://calendly.com/ozgurdemirbacak/growth-call',
    },
    {
        id: '4',
        title: 'Mail',
        icon: '/images/socials/mail.png',
        url: 'mailto:ozgur@scalvate.com',
    },
]
